...
import pickle
import ray
from Utility_fun import CircleOnSphereSampling, cart2sph, RandomPtsCone, LSCV_BW
...
for N in [500, 1000, 2000]:
    for job_id in range(1, 1001):
        ...
        with open('./Results/Simulation4_N_'+str(N)+'_'+str(job_id)+'.dat', "wb") as file:
